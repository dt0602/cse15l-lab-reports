...
I forked this repository from the lab document to my account and opened Github Desktop to clone the repository. Then I copied the url of the forked repository. After ssh'ing into the ieng6 account, I typed `git clone` and pasted the url and hit `<enter>` to clone the directory into the ieng6 account.
